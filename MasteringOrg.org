...
#+cindex:syntax
#+cindex:context-free
#+texinfo:@heading Context-free Elements

A core concept in Org's syntax is that only
- [[*Headlines][headlines]],
- [[*Sections][sections]],
- [[*Planning Lines][planning lines]] and
...
#+cindex:environment
Every other syntactical part exists within specific /environments/.  Three categories are used to classify these environments:
