...
#+cindex:syntax
#+cindex:context-free
A core concept in this syntax is that only *headlines*, *sections*, *planning lines* and *property
drawers* are context-free1.  Every other syntactical part only exists within specific environments

** Context-Free Elements---Headlines and Sections
...
#+cindex:environment
are context-free.  Every other syntactical part exist within specific /environments/.  Three
