...
#+date:2020-02-03 06:19
#+macro:version Version 0.7.8
...
#+begin_defun
Determines the /type/ and /attribues/ of the closest /element/ to point.
...
- RETURN VALUE :: is a list of ~(type, props)~, where
  ...
  - PROPS :: a plist of properties associated with the element.  The exact properties dependes on the
    type, but will always include the following:
