...
#+date:2020-03-28 20:06
#+macro:version Version 0.8.10
...
- OPTIONAL :: can contain any character but a new line; the following keys are the only ones that
  con contain an OPTIONAL element:
  - CAPTION
  - RESULTS
...
The /paragraph/ is the unit of measurement.

#+cindex:types
#+cindex:environments
#+texinfo:@heading Types or Environments

Every other syntactical part exists within specific /environments/.  Three categories are used to
...
#+texinfo:@subheading Properties common to all types
